...
public final class TAResearchGolemcraft_Advansed {
    private TAResearchGolemcraft_Advansed() {}

    public static void inject() {
        final String KEY = "TA_GOLEMCRAFT_AD";
        final String CAT = "GOLEMANCY";
        final int COL = 5, ROW = 8;
        final String PARENT = "TA_GOLEMCRAFT";
        ...
        ItemStack icon;
        Item crafterItem = Item.getItemFromBlock(ModBlocksItems.ARCANE_CRAFTER);
        ...
        sIntro.setText("research.TA_GOLEMCRAFT_AD.text.intro"); // показывается ДО открытия
        sIntro.setKnow(new ResearchStage.Knowledge[]{
                new ResearchStage.Knowledge(IPlayerKnowledge.EnumKnowledgeType.THEORY, aura, 2),
        ...
        sIntro.setObtain(buildObtainList(
                new ItemStack(Item.getItemFromBlock(ModBlocksItems.GOLEM_CRAFTER)),
        ...
        sMain.setText("research.TA_GOLEMCRAFT_AD.text.main"); // показывается ПОСЛЕ завершения
        // Рецепты разблокируются при завершении исследования
        sMain.setRecipes(new ResourceLocation[]{
                new ResourceLocation(ThaumicAttempts.MODID, "pattern_arcane"),
