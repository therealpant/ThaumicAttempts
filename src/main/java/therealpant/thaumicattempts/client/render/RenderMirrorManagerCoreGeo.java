...
import therealpant.thaumicattempts.client.model.MirrorManagerCoreModel;
import therealpant.thaumicattempts.golemnet.tile.TileMirrorManagerCore;

@SideOnly(Side.CLIENT)
public class RenderMirrorManagerCoreGeo extends GeoBlockRenderer<TileMirrorManagerCore> {
    ...
    public RenderMirrorManagerCoreGeo() {
        super(new MirrorManagerCoreModel());
    }

    private void renderEmissiveLayer(TileMirrorManagerCore te,
    ...
    @Override
    public void render(TileMirrorManagerCore te,
                       double x, double y, double z,
                       float partialTicks,
                       int destroyStage,
                       float alpha) {
