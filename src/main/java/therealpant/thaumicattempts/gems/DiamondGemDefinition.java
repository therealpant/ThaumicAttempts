...
public class DiamondGemDefinition implements ITAGemDefinition {
    public static final ResourceLocation ID = new ResourceLocation(ThaumicAttempts.MODID, "diamond");
    public static final int TIER1_DURABILITY = 400;
    public static final int TIER2_DURABILITY = 450;
    public static final int TIER3_DURABILITY = 500;
    ...
    public int getMaxTier() {
        return DiamondEffects.MAX_TIER;
    }
    ...
    public GemDamageSource getDamageSource() {
        return GemDamageSource.ON_PLAYER_HIT;
    }
