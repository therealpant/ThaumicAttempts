...
public class CloudTask {
    ...
    public int getInflightAmount() { return inflightAmount; }
    ...
    public void setInflightAmount(int inflightAmount, long tick) {
        this.inflightAmount = Math.max(0, inflightAmount);
        this.updatedTick = tick;
    }
    ...
    public NBTTagCompound serializeNBT() {
        ...
        nbt.setInteger("inflightAmount", inflightAmount);
    ...
    public static CloudTask deserializeNBT(NBTTagCompound nbt) {
        ...
        task.inflightAmount = nbt.hasKey("inflightAmount") ? Math.max(0, nbt.getInteger("inflightAmount")) : 0;
